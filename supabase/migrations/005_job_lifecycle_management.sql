...
CREATE INDEX idx_job_updates_created_at ON job_updates(created_at);
CREATE INDEX idx_job_conversations_job_id ON job_conversations(job_id);
CREATE INDEX idx_job_conversations_course_id ON job_conversations(course_id);
CREATE INDEX idx_job_conversations_professional_id ON job_conversations(professional_id);
